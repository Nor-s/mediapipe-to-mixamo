...
class WindowClass(QMainWindow, Ui_Dialog) :
    def __init__(self) :
        ...
        self.h_slider_max_frame_num.valueChanged.connect(self.set_lbl_max_frame_num)
    ...
    def set_lbl_max_frame_num(self):
        self.lbl_slider_max_frame_num.setText(str(self.h_slider_max_frame_num.value()))
    ...
    def convert(self):
        ...
        try:
            ...
            anim_json = glmh.get_anim_json3(mixamo_json_object, model_path, is_hips_move= is_move_hips, min_visibility= min_visibility)
