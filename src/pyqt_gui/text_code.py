...
# Form implementation generated from reading ui file './gui.xml'
#
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.frame.setGeometry(QtCore.QRect(10, 10, 311, 571))
        ...
        self.lbl_display = QtWidgets.QLabel(self.frame)
        ...
        self.gridLayout_3.addWidget(self.lbl_display, 0, 1, 1, 1)
        self.btn_add_gif = QtWidgets.QPushButton(self.frame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_3.addWidget(self.btn_add_gif, 3, 1, 1, 1)
        self.cmb_gif = QtWidgets.QComboBox(self.frame)
        self.cmb_gif.setObjectName("cmb_gif")
        self.gridLayout_3.addWidget(self.cmb_gif, 3, 2, 1, 1)
        self.lbl_display2 = QtWidgets.QLabel(self.frame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_3.addWidget(self.lbl_display2, 2, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.cmb_model, 1, 2, 1, 1)
        self.btn_add_model = QtWidgets.QPushButton(self.frame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_3.addWidget(self.btn_add_model, 1, 1, 1, 1)
        self.verticalLayout.addLayout(self.gridLayout_3)
        self.lbl_gif_movie = QtWidgets.QLabel(self.frame)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.lbl_gif_movie.sizePolicy().hasHeightForWidth())
        self.lbl_gif_movie.setSizePolicy(sizePolicy)
        self.lbl_gif_movie.setMinimumSize(QtCore.QSize(0, 0))
        self.lbl_gif_movie.setMaximumSize(QtCore.QSize(300, 200))
        self.lbl_gif_movie.setText("")
        self.lbl_gif_movie.setScaledContents(True)
        self.lbl_gif_movie.setObjectName("lbl_gif_movie")
        self.verticalLayout.addWidget(self.lbl_gif_movie)
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(0, 10, 281, 151))
        self.layoutWidget.setObjectName("layoutWidget")
        self.gridLayout_4 = QtWidgets.QGridLayout(self.layoutWidget)
        self.gridLayout_4.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_4.setObjectName("gridLayout_4")
        self.btn_add_output = QtWidgets.QPushButton(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.cmb_output = QtWidgets.QComboBox(self.layoutWidget)
        ...
        self.gridLayout.addWidget(self.lbl_slider_max_frame_num, 2, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.h_slider_max_frame_num, 2, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.h_slider_model_complexity, 1, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.lbl_slider_model_complexity, 1, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.chk_is_move, 3, 0, 1, 1)
